<?php
    // $page = "admin";
    include "../koneksi.php";
	$tabel1 = "t_pengajuan_jad";
	$tabel2 = "t_dosen";
	
	$sql = "SELECT $tabel2.nama_dsn, $tabel1.kd_dsn, $tabel1.usulan_j, $tabel1.status_usulan FROM $tabel2 INNER JOIN $tabel1 ON $tabel2.kd_dsn = $tabel1.kd_dsn";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Pengajuan Jabatan Fungsional Dosen</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Pengajuan Jafung Dosen</h4>
                        <div class="row">
                            <div class="col-xs-12 col-md-2">
                        <a class="btn btn-outline-success btn-lg btn-block" href="pengajuan-jad-add.php" target="">Tambah</a></p>
                        </div>
                        </div>
					</div>
					<div class="pb-20">
